...
const cpCaballeros = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/catalogo/pantalonetasCatalogoCaballeros.flow");
const cpDamas = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/catalogo/pantalonetasCatalogoDamas.flow");
const cpNinios = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/catalogo/pantalonetasCatalogoNinios.flow");
const cpParejas = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/catalogo/pantalonetasCatalogoParejas.flow");
const cpUnicolor = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/catalogo/pantalonetasCatalogoUnicolor.flow");

const ppCaballeros = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/precios/CPPCaballero");
const ppDamas = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/precios/CPPDamas");
const ppNinios = require("./flows/menuPPL/catalogo/pantalonetas/pantalonetasSub/precios/CPPNinios");
